...
# 🎮 Sovereign Tower — Community Edition

**Defend the realm in this standalone Community Edition build.**
...
Sovereign Tower is a strategy game that combines tower defense with kingdom management. Players construct fortifications, command defenders, and manage resources across escalating campaign maps and survival modes. This standalone Community Edition is a self-contained package with no storefront required, and it is ready to play immediately after installation.

This build is for players seeking an offline, self-contained strategy experience that runs without a storefront or account.
...
<table>
 <tr>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/4113940/284600fd171327f0206364b3ac32fe4d51acc069/ss_284600fd171327f0206364b3ac32fe4d51acc069.1920x1080.jpg?t=1788275767" alt="Screenshot 1" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/4113940/eaba92c131b0cd5cf4b461b769fc89ec9265a9e1/ss_eaba92c131b0cd5cf4b461b769fc89ec9265a9e1.1920x1080.jpg?t=1788275767" alt="Screenshot 2" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/4113940/f6900fc85e952e7e04af335018fa5ba24f860d77/ss_f6900fc85e952e7e04af335018fa5ba24f860d77.1920x1080.jpg?t=1788275767" alt="Screenshot 3" width="100%"></td>
 </tr>
</table>
...
- 🏰 **Kingdom Construction** — Design and expand your stronghold with modular walls, towers, and production buildings.
- ⚔️ **Tactical Defense Combat** — Position units and towers against escalating enemy waves with terrain-based tactics.
- 🧭 **Campaign and Survival Modes** — Includes the full campaign, endless survival mode, and all expansion content.
- 🌐 **LAN and Direct Connection** — LAN or direct connection supported for cooperative defense sessions.
- 🛠️ **Modding Support** — Community modding tools allow custom maps, enemy types, and balance adjustments.
- 📴 **Offline Play** — Fully functional offline version with no account or storefront required.
- 💾 **Self-Contained Package** — No additional software required; all dependencies are included in the build.
- 🌍 **Multiple Interface Languages** — Interface localized into seven languages with full text translation.

- **Compression:** Lossless
- **Install Time:** ~4 minutes on SSD, ~10 minutes on HDD
- **Recoding:** none
- **Selective Download:** Not applicable — the self-contained package includes all content

---

## 📦 DLCs Included

- Sovereign Tower: Northern Front
- Sovereign Tower: Architects Pack
...
| **RAM** | 6 GB | 8 GB |
| **Graphics** | NVIDIA GeForce GTX 750 Ti / AMD Radeon RX 560 (2 GB VRAM) | NVIDIA GeForce GTX 1060 / AMD Radeon RX 580 (4 GB VRAM) |
| **Storage** | 12 GB available space | 12 GB on an SSD |
| **Additional** | DirectX 11 compatible sound card | DirectX 12, keyboard and mouse or gamepad |
...
> 💡 **Saves location:** `%LOCALAPPDATA%\SovereignTower\Saved`
